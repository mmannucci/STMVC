        ...
        <div class="body">
            ...
            <g:form controller="editore" action="update.dispatch" method="POST" >
                ...
                <div class="buttons">
                    ...
                    <span class="button"><g:link action="delete.dispatch" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');">Delete</g:link></span>
                </div>
            </g:form>
        </div>
    </body>
