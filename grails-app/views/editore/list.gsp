...
<html>
    ...
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link controller="editore" class="create" controller="editore" action="create.dispatch"><g:message code="default.new.label" args="[entityName]" /></g:link></span>
        </div>
        <div class="body">
