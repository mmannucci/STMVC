        ...
        <div class="body">
            ...
            <div class="buttons">
                <g:form>
                    ...
                    <span class="button"><g:actionSubmit class="edit" controller="${domainClass.shortName.toLowerCase()}" action="edit" value="\${message(code: 'default.button.edit.label', default: 'Edit')}" /></span>
