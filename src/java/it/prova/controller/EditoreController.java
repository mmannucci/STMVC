...
public class EditoreController {
	...
	public String show(@PathVariable("id") Long id, HttpServletRequest request, ModelMap modelMap) {
		request.setAttribute(org.codehaus.groovy.grails.web.servlet.GrailsApplicationAttributes.CONTROLLER_NAME_ATTRIBUTE, "editore");
	...
	public String edit(@PathVariable("id") Long id, HttpServletRequest request, ModelMap modelMap) {
		request.setAttribute(org.codehaus.groovy.grails.web.servlet.GrailsApplicationAttributes.CONTROLLER_NAME_ATTRIBUTE, "editore");
		if (id == null) throw new IllegalArgumentException("An Identifier is required");
		modelMap.addAttribute("editoreInstance", Editore.get(id));
		return "/editore/edit";
	...
	public String delete(@PathVariable("id") Long id, @RequestParam(value = "offset", required = false) Integer offset, @RequestParam(value = "max", required = false) Integer max, HttpServletRequest request) {
		request.setAttribute(org.codehaus.groovy.grails.web.servlet.GrailsApplicationAttributes.CONTROLLER_NAME_ATTRIBUTE, "editore");
		if (id == null) throw new IllegalArgumentException("An Identifier is required");
